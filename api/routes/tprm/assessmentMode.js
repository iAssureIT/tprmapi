...
router.post('/',checkAuth,AssessmentModeController.create_assessmentModes);

router.get('/list',AssessmentModeController.list_assessmentModes);

router.get('/list/:company_ID',checkAuth,AssessmentModeController.list_assessmentModes_company_ID);
...
router.delete('/:assessmentmodes_ID',checkAuth,AssessmentModeController.delete_assessmentModes);
