...
router.post('/create_Customize_framework/:framework_ID',checkAuth,FrameworkController.create_Customize_framework);
...
router.get('/:framework_ID',checkAuth,FrameworkController.detail_framework);
...
router.get('/frameworks_count_of_admin/:user_ID',checkAuth,FrameworkController.frameworks_count_of_admin);

router.get('/company/list/:company_ID/:user_ID/:stage/:frameworktype',checkAuth,FrameworkController.list_allcustUserframework_stage);

router.get('/company_frameworks_count/:user_ID/:company_ID',checkAuth,FrameworkController.frameworks_count_of_company);
...
router.put('/state_stage',checkAuth,FrameworkController.update_framework_stage_state);

router.put('/controlblock/:action/:framework_ID',checkAuth,FrameworkController.update_controlblock);

router.delete('/:framework_ID',checkAuth,FrameworkController.delete_framework);
